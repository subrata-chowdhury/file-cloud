        ...
        <div className="space-y-8">
          ...
          <section>
            ...
            {loading ? (
              ...
              <>
                <div
                  className={`grid gap-3 sm:gap-6 ${viewMode === 'grid' ? 'grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5' : 'grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4'}`}
                >
                  {files.map((file) => (
                    <FileCard
                      key={file.id}
