  ...
  if (!profile) {
    return (
      <div className="mx-auto max-w-3xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="mb-6 h-8 w-32 animate-pulse rounded bg-zinc-200 dark:bg-zinc-800"></div>
        ...
        <div className="space-y-5">
          ...
          <div className="rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
            <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
              <div className="flex items-center gap-4">
                <div className="h-14 w-14 shrink-0 animate-pulse rounded-2xl bg-zinc-200 dark:bg-zinc-800"></div>
                <div className="space-y-2">
                  <div className="h-5 w-40 animate-pulse rounded bg-zinc-200 dark:bg-zinc-800"></div>
                  <div className="h-4 w-48 animate-pulse rounded bg-zinc-200 dark:bg-zinc-800"></div>
                </div>
              </div>
          ...
          <div className="rounded-2xl border border-zinc-200 bg-white shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
            ...
            <div className="p-5">
              <div className="flex items-center gap-4">
                <div className="h-10 w-10 shrink-0 animate-pulse rounded-xl bg-zinc-200 dark:bg-zinc-800"></div>
          ...
          <div className="rounded-2xl border border-zinc-200 bg-white shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
            ...
            <div className="flex flex-col items-start justify-between gap-4 p-5 sm:flex-row sm:items-center">
              ...
              <div className="h-8 w-28 shrink-0 animate-pulse rounded-lg bg-zinc-200 dark:bg-zinc-800"></div>
            </div>
            <div className="flex flex-col items-start justify-between gap-4 border-t border-zinc-100 p-5 sm:flex-row sm:items-center dark:border-zinc-800">
              <div className="flex-1 space-y-2">
                <div className="h-4 w-32 animate-pulse rounded bg-zinc-200 dark:bg-zinc-800"></div>
                <div className="h-3 w-3/4 animate-pulse rounded bg-zinc-200 dark:bg-zinc-800"></div>
              </div>
