...
export default function Pagination({ currentPage, totalPages, onPageChange }: PaginationProps) {
  ...
  return (
    <div className="mt-6 flex items-center justify-between rounded-xl border-t border-gray-200 bg-white px-4 py-3 shadow-sm sm:px-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              if (
                ...
                return (
                  <button
                    ...
                    className={`relative inline-flex items-center px-4 py-2 text-sm font-semibold ring-1 ring-gray-300 ring-inset focus:z-20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-900 dark:ring-gray-700 dark:focus-visible:outline-white ${
                      isCurrent
                        ? 'z-10 bg-gray-900 text-white ring-transparent focus-visible:outline-gray-900 dark:bg-white dark:text-gray-900 dark:focus-visible:outline-white'
                ...
                return (
                  <span
                    key={`ellipsis-${page}`}
                    className="relative inline-flex items-center px-4 py-2 text-sm font-semibold text-gray-700 ring-1 ring-gray-300 ring-inset focus:outline-offset-0 dark:text-gray-400 dark:ring-gray-700"
                  >
                    ...
                  </span>
                );
